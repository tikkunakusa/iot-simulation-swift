...
void parse_modem_mqtt_if_present(const char* str);
...
bool modem_is_mqtt_connected(void);
bool modem_is_mqtt_pub_success(void);
void modem_reset_mqtt_pub_status(void);
void modem_reset_mqtt_connect_status(void);
